# About
BB-Man is a RADIUS web management application aimed at managing general-purpose ISP deployments. It features user management, graphical reporting, and accounting

It's based on a FreeRADIUS (http://www.freeradius.org) deployment with a database server serving as the backend.
